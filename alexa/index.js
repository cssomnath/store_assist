...
function handleAnswerRequest(intent, session, callback) {
    ...
    // speechOutput = "You answered " + answerSlotValid;
    // repromptText = "Is there anything else I can do for you";
    ...
    speechOutput = "The best plan is Verizon for dollar two fifty " + productName;
    callback(sessionAttributes,
